#!/usr/bin/env python3
"""
DEEP CLEAR - Clear display 5 times to remove all ghosting.
"""
...
def main():
    print("=== DEEP CLEAR - 5 CYCLES ===\n")
    print("This will clear the display 5 times to remove ALL ghosting\n")
    ...
    try:
        ...
        # Clear 5 times
        for i in range(5):
            print(f"Clear cycle {i+1}/5...", end='', flush=True)
            clear_to_white(spi)
            print(" DONE")
            time.sleep(1)

        print("\n✅ COMPLETE!")
        print("Display should be PURE WHITE now with NO ghosting\n")
